          ...
          <el-form-item class="input" label="薪资要求" prop="xinziyaoqiu">
              <el-input v-model="ruleForm.xinziyaoqiu" 
                placeholder="薪资要求" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="期望城市" prop="qiwangchengshi">
          <el-input v-model="ruleForm.qiwangchengshi" 
              placeholder="期望城市" clearable  :readonly="ro.qiwangchengshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="期望城市" prop="qiwangchengshi">
              <el-input v-model="ruleForm.qiwangchengshi" 
                placeholder="期望城市" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xinziyaoqiu = true;
            continue;
	            	            ...
	            	            if(o=='qiwangchengshi'){
            this.ruleForm.qiwangchengshi = obj[o];
	    this.ro.qiwangchengshi = true;
            continue;
          }
	                    }
                                                                                                                                                                                                              }
